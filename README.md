...
- 鍵を暗号化せずそのまま平文で送っているため、通信路を傍受されれば鍵が漏れます。鍵配送の問題を解決するハイブリッド暗号方式については、別リポジトリ [hybrid-crypto-login-demo](https://github.com/razy6174/hybrid-crypto-login-demo) で扱っています。
